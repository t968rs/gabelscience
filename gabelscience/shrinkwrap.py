...
class ShrinkwrapRaster:
    ...
    def create_geometry(df):
        df['geometry'] = df.apply(lambda row: shapely.Point(float(row['x']), float(row['y'])), axis=1)
        return df
...
if __name__ == "__main__":
    input_polygons = r"E:\Iowa_2A\02_mapping\Lower_DesMoines\00_Conveyance_0912\Conveyance_01pct_07.shp"
    input_grid = r"E:\Iowa_2A\02_mapping\Lower_DesMoines\00_Conveyance_0912\WSE_01pct_Filtered1_0912.tif"
    output_folder = r"E:\Iowa_2A\02_mapping\Lower_DesMoines\gabelshrink_test"
