...
from src.d00_utils import bounds_to_polygon
...
class CreateRasterIndex:
    ...
    @staticmethod
    def raster_extents_to_gdf(raster_dict, tgt_crs):
    ...
    def tile_rasters(self):
        ...
        out_shp = os.path.join(self.output_folder, f"Index_{self.outname_str}.shp")
        tile_gdf.to_file(out_shp)
        PrintFileInfo(out_shp, "Shapefile")


if __name__ == "__main__":
    root_raster_folder = r"A:\Iowa_1A\02_mapping\Grids_Lower_Cedar\Terrain\Lower_Cedar_26915"
    output_folder = r"A:\Iowa_1A\02_mapping\Grids_Lower_Cedar\Terrain"
    target_crs = 3417
    move_files = False
