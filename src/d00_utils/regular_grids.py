...
if __name__ == "__main__":
    shppath = r"E:\Iowa_2A\02_mapping\Lower_DesMoines\Terrain\indices\tile_index_lower_demoines.shp"
    ingdf = get_gdf_from_fc(shppath)[0].to_crs(epsg=3418)
    grid = create_regular_grid(ingdf, n_cells=(5, 5), epsg_code=3417)[0].loc[:, ["geometry"]]
    grid.to_file(r"E:\Iowa_2A\02_mapping\Lower_DesMoines\Terrain\indices\index_3418.shp", driver="ESRI Shapefile")